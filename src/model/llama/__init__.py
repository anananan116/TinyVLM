...
from .visual import JinaCLIPVisionConfig
...
def get_model_and_tokenizer(model_args, additional_tokens_dict, device="cuda", load_vision_model=None):
    ...
    config.visual_config = JinaCLIPVisionConfig()
